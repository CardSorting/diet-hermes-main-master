...
import { ensureLaunchCwdEnv } from "./utils/launch-cwd";

// Pin workspace cwd before the gateway subprocess starts (covers ``bun dev``
// without ``dietcode --tui``). The Python launcher already sets these vars.
ensureLaunchCwdEnv(hermesAgentRoot())

...
def build_welcome_banner(console: Console, model: str, cwd: str,
    ...
    left_lines.append(f"[{accent}]{model_short}[/]{ctx_str} [dim {dim}]·[/] [dim {dim}]{subtitle}[/]")
    tagline = _skin_branding("tagline", "").strip()
    if tagline:
        left_lines.append(f"[italic {dim}]{tagline}[/]")

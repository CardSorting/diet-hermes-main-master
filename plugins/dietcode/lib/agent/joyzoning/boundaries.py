"""Architectural layer boundaries — habitat vs runtime vs mutation vs verification."""
...
class RuntimeLayer(str, Enum):
    ...
    HABITAT = "habitat"  # representational — JoyZoning UI / operator cognition
...
# Event types → owning layer (for journal tagging and habitat streams).
_EVENT_LAYER: dict[str, RuntimeLayer] = {
    ...
    "habitat.snapshot": RuntimeLayer.HABITAT,

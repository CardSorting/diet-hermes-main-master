...
import DietCodePage from "@/pages/DietCodePage";
...
export default function App() {
  ...
  const chatOverriddenByPlugin = useMemo(
    () => manifests.some((m: PluginManifest) => m.tab.override === "/chat"),
    [manifests],
  );
  ...
  const pluginTabMeta = useMemo(
    () =>
      manifests
        .filter((m: PluginManifest) => !m.tab.hidden)
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography
          className="font-bold text-[0.95rem] leading-[0.95] tracking-wider text-midground"
        ...
        <div className="flex min-h-0 min-w-0 flex-1">
          ...
          >
            ...
            >
              <ul className="flex flex-col">
                {sidebarNav.coreItems.map((item: NavItem) => (
                  <SidebarNavLink
              ...
              {sidebarNav.pluginItems.length > 0 && (
                ...
                >
                  ...
                  <ul className="flex flex-col">
                    {sidebarNav.pluginItems.map((item: NavItem) => (
                      <SidebarNavLink
                        closeMobile={closeMobile}
                        item={item}
                        key={item.path}
          ...
          <PageHeaderProvider pluginTabs={pluginTabMeta}>
            ...
            >
              ...
              >
                <Routes>
                  {routes.map(({ key, path, element }: { key: string; path: string; element: any }) => (
            ...
            <li key={action}>
              <ListItem
                ...
                className={cn(
                  ...
                  "font-mondwest text-[0.75rem] tracking-widest",
                  "transition-opacity",
                  busy

...
| `HERMES_TUI_DIR` | Path to a prebuilt `herm-tui/` directory (must contain `dist/index.js` and runtime assets). Used by distros and Nix to skip the first-launch `bun install`. |
